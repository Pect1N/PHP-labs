      ...
      <table>
        <tr>
          <td>
            ТАРА:
            <br>
            <select size='4' multiple name='tara[]'>
              <p><option name='tar' value='t1'>Бьющаяся</p>
              <p><option name='tar' value='t2'>Хрупкая</p>
              <p><option name='tar' value='t3'>Водонепроницаемая</p>
              <p><option name='tar' value='t4'>Пожароопасная</p>
              </select>
          </td>
          <td>
            ВЕС:       
